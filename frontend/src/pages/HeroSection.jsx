...
const HeroSection = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between bg-[#FAEDCB] w-full h-screen px-5 lg:px-10">
      {/* Left Section */}
      <div className="flex flex-col w-[50%] h-full ml-20 mt-16">
        ...
        <p className="font-comic-neue font-normal ml-1 text-[24px] leading-[28px]  text-black mt-5 ">
        ...
        <h3 className='ml-1 mt-2 font-light text-md'><span className='text-red-700'>*</span>We’ll only send what’s worth opening – no spam, guaranteed!</h3>
      </div>
      {/* Right Section (Image) */}
      <div className="flex justify-center items-center w-[50%]  mt-[-60px]">
        <img src="/herosection.png" alt="Hero Section" className='w-full p-12 mr-20' />
      </div>
    </div>
  );
};
