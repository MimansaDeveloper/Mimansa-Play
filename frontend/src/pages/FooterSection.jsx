...
const FooterSection = () => {
  return (
    <footer className="bg-[#C5DEF2] py-[8vw] lg:py-10">
      <div className="max-w-[90vw] lg:max-w-[80vw] mx-auto flex flex-col lg:flex-row justify-between items-center lg:items-start">
        ...
        <div className="mb-[6vw] lg:mb-0">
          <img src="/logo1.png" alt="Mimansa Kids Logo" className="w-[60vw] sm:w-[30vw] lg:w-[12vw]" />
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-20 space-y-[6vw] lg:space-y-0">
          {/* Social Links */}
          <div>
            <h3 className="font-semibold text-[2.5vw] lg:text-[1vw] text-[#A1A1A1] mb-[3vw] lg:mb-4">SOCIAL</h3>
            <ul className="space-y-[2vw] lg:space-y-2 text-[#454545] text-[4vw] sm:text-[2vw] lg:text-[1.02vw]">
              <li className="flex items-center">
                <a href="https://www.facebook.com/people/Mimansa-Kids/61557931594123/" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  <svg width="14" height="23" viewBox="0 0 14 23" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-[2vw] lg:mr-2">
                    <path fillRule="evenodd" clipRule="evenodd" d="M12.6658 4.2201L10.5309 4.22146C8.85676 4.22146 8.53214 4.98401 8.53214 6.1027V8.57114H12.5254L12.0052 12.4383H8.53214V22.3583H4.36875V12.4383H0.887207V8.57114H4.36875V5.72074C4.36875 2.4109 6.47667 0.609863 9.55421 0.609863C11.0285 0.609863 12.2958 0.714528 12.6658 0.762102V4.2201Z" fill="#454545" />
                  </svg>
                  Facebook
                </a>
              </li>
              <li className="flex items-center">
                <a href="https://www.instagram.com/mimansakids/" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-[2vw] lg:mr-2">
              ...
              <li className="flex items-center">
                <a href="https://www.linkedin.com/company/mimansakids/" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-[2vw] lg:mr-2">
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-semibold text-[2.5vw] lg:text-[1vw] text-[#A1A1A1] mb-[3vw] lg:mb-4">COMPANY</h3>
            <ul className="space-y-[2vw] lg:space-y-2 text-[#454545] text-[4vw] sm:text-[2vw] lg:text-[1.02vw]">
              <li>Home</li>
              <li>Why Us</li>
              <li>How It Works</li>
          ...
          {/* Support Links */}
          <div>
            <h3 className="font-semibold text-[2.5vw] lg:text-[1vw] text-[#A1A1A1] mb-[3vw] lg:mb-4">SUPPORT</h3>
            <ul className="space-y-[2vw] lg:space-y-2 text-[#454545] text-[4vw] sm:text-[2vw] lg:text-[1.02vw]">
        ...
        <div className="flex flex-col items-center">
          <h3 className="font-semibold text-[2.5vw] lg:text-[1vw] text-center mb-[3vw] lg:mb-4">COMING SOON ON</h3>
          <div className="flex flex-col space-y-[4vw] lg:space-y-4">
            <img src="/appstore.png" alt="App Store" className="w-[50vw] sm:w-[30vw] lg:w-[15.5vw]" />
            <img src="/googleplay.png" alt="Google Play" className="w-[50vw] sm:w-[30vw] lg:w-[15.5vw]" />
          </div>
        </div>
      </div>
      ...
      <div className="mt-[6vw] lg:mt-6 text-center flex flex-col items-center lg:items-start px-[8vw] lg:px-36">
        <p className="text-[3.5vw] lg:text-[0.9vw] text-[#A1A1A1]">hello@mimansaplay.com</p>
        <p className="text-[3.5vw] lg:text-[0.9vw] text-[#A1A1A1]">© 2024 Mimansa Kids</p>
      </div>
    </footer>
  );
};
