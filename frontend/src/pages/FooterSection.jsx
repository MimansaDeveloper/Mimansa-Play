    ...
    <footer className="bg-[#C5DEF2] py-10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start">
        ...
        <div className="flex flex-col md:flex-row md:space-x-20 space-y-8 md:space-y-0">
          {/* Social Links */}
          <div>
            <h3 className="font-semibold text-[16px] text-[#A1A1A1] mb-4">SOCIAL</h3>
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-semibold text-[16px] text-[#A1A1A1] mb-4">COMPANY</h3>
            <ul className="space-y-2 text-[#454545]">
              <li>Home</li>
              <li>Why Us</li>
              <li>How It Works</li>
          ...
          {/* Support Links */}
          <div>
            <h3 className="font-semibold text-[16px] text-[#A1A1A1] mb-4">SUPPORT</h3>
            <ul className="space-y-2 text-[#454545]">
        ...
        <div className='w-[0.125vw] h-[13vw] py-4 opacity-[60%] bg-[#A1A1A199]'></div>
      ...
      <div className='max-w-full  mx-36 my-2 h-[0.125vw] opacity-[60%] bg-[#A1A1A199]'></div>

      {/* Footer Bottom Section */}
      <div className="mt-6 text-center flex flex-col items-start px-36">
      <p className="text-sm text-[#A1A1A1]">hello@mimansaplay.com</p>
        <p className="text-sm text-[#A1A1A1]">© 2024 Mimansa Kids</p>
      </div>
    </footer>
  );
};
