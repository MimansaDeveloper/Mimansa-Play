      ...
      <div className="flex flex-col items-center w-full max-w-[1200px] max-md:max-w-full">
            ...
            <div className="w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center whitespace-nowrap max-md:mt-10">
                <img
                  ...
                  className="object-contain self-stretch w-[90%] aspect-[0.89]"
                />
            ...
            <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center whitespace-nowrap max-md:mt-10">
                <img
                  ...
                  className="object-contain self-stretch w-[90%] rounded-xl aspect-[0.89]"
                />
            ...
            <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-center max-md:mt-10">
                <img
                  ...
                  className="object-contain self-stretch w-[90%] rounded-xl aspect-[0.9]"
                />
                <div className="mt-7 text-3xl font-bold text-black">Akshay</div>
            ...
            <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center self-stretch my-auto max-md:mt-10">
                <img
                  ...
                  className="object-contain self-stretch w-[90%] aspect-[0.91]"
                />
            ...
            <div className="w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-center max-md:mt-10">
                <img
                  ...
                  className="object-contain self-stretch w-[90%] rounded-xl aspect-[0.92]"
                />
                <div className="mt-7 text-3xl font-bold text-black">
                  Rithesh
                </div>
            ...
            <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center max-md:mt-10">
                <img
                  ...
                  className="object-contain self-stretch w-[90%] aspect-[0.92]"
                />
          ...
          <div className="flex gap-5 max-md:flex-col">
            <div className="w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-center mt-14 max-md:mt-10">
                <div className="flex shrink-0 self-stretch rounded-xl bg-zinc-300 h-[252px] w-[90%]" />
                <div className="mt-7 text-3xl font-bold text-black">Zack</div>
                <div className="mt-1 text-base font-medium text-center text-stone-600 w-[278px]">
                  Applied Research Engineer - Speech Recognition
                </div>
                <img
            ...
            <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-center max-md:mt-10">
                <img
                  ...
                  className="object-contain self-stretch w-[90%] rounded-xl aspect-[0.92]"
                />
                <div className="mt-7 text-3xl font-bold text-black">Pranav</div>
                <div className="mt-1 text-base font-medium text-center text-stone-600 w-[278px]">
                  Applied Research Engineer - Speech Recognition
                </div>
                <img
            ...
            <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center mt-1.5 max-md:mt-10">
                <img
                  ...
                  className="object-contain self-stretch w-[90%] aspect-[0.93]"
                />
                <div className="mt-5 text-3xl font-bold text-black">Hriday</div>
        ...
        <div className="flex flex-col items-center" data-aos="fade-up">
          <img
            ...
            className="object-contain mt-32 max-w-full rounded-xl aspect-[0.95] w-[250px] max-md:mt-10"
          />
        ...
        />
        <div
          className="flex flex-col items-start self-stretch px-20 mt-40 w-full max-md:px-5 max-md:mt-10 max-md:max-w-full"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          <div className="self-stretch max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col">
              <div className="w-[33%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow items-center max-md:mt-10">
                  <div className="flex overflow-hidden flex-col items-center self-stretch px-4 pt-8 bg-orange-200 aspect-square rounded-[150px_221px_221px_150px] w-[90%]">
                    <img
                  ...
                  <div className="mt-12 text-3xl font-bold text-black max-md:mt-10">
                    Shouvik Das
                  </div>
                  <img
              ...
              <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow max-md:mt-10">
                  <div className="flex overflow-hidden flex-col items-center bg-teal-200 aspect-square rounded-[90px] w-[90%] mx-auto">
                    <img
              ...
              <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow max-md:mt-10">
                  <div className="flex overflow-hidden flex-col items-center bg-sky-300 aspect-square rounded-[90px_120px_60px_90px] w-[90%] mx-auto">
                    <img
                      src="https://cdn.builder.io/api/v1/image/assets/TEMP/1611e51e7bbf7adb19ce5b9e2d84457f6d7b50fe?placeholderIfAbsent=true"
                      className="object-contain w-full aspect-square"
                    />
                  </div>
                  <div className="mt-14 text-3xl font-bold text-black max-md:mx-0.5 max-md:mt-10 text-center">
                    Mrityunjay Kumar
                  </div>
                  <img
          ...
          <div className="flex flex-col items-center w-full mt-32 max-md:mt-10">
            <div className="flex overflow-hidden flex-col items-center px-3.5 pt-7 aspect-square bg-slate-400 rounded-[221px_221px_120px_120px] w-[230px]">
              <img
