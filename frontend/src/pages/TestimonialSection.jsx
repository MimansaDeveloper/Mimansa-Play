  ...
  return (
    <div className="bg-[#F8D9C4] flex flex-col items-center py-20">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8">
        {/* Testimonial 1 */}
        <div className="bg-white border-2 border-black rounded-[16px] w-[340px] flex flex-col items-center p-6 relative">
          {/* Profile Image */}
          ...
          {/* Quote */}
          <p className="font-comic-neue text-[22px] text-center text-[#454545] mt-[80px] mb-6 leading-[30px]">
          ...
          <div className="w-full bg-[#E1FFD3] rounded-b-[16px] flex justify-center items-center py-4">
            <p className="font-comic-neue text-[22px] font-bold text-black text-center">
        ...
        <div className="bg-white border-2 border-black rounded-[16px] w-[340px] flex flex-col items-center  relative md:mt-[-40px]"> {/* Adjusted margin to raise Raj's card */}
          {/* Profile Image */}
          <div className="absolute top-[-64px] left-1/2 transform -translate-x-1/2 w-[128px] h-[128px] rounded-full overflow-hidden">
            <img
        ...
        {/* Testimonial 3 */}
        <div className="bg-white border-2 border-black rounded-[16px] w-[340px] flex flex-col items-center  relative">
          {/* Profile Image */}
          <div className="absolute top-[-64px] left-1/2 transform -translate-x-1/2 w-[128px] h-[128px] rounded-full overflow-hidden ">
            <img
